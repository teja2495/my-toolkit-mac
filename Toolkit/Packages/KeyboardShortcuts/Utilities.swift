	...
	*/
	var localized: String {
		let table: [String: String] = [
			...
			"space_key": "Space",
			"keyboard_shortcut_used_by_menu_item": "The keyboard shortcut %@ is already used by the menu item \"%@\".",
			"keyboard_shortcut_disallowed": "This keyboard shortcut cannot be used.",
			"keyboard_shortcut_used_by_system": "This keyboard shortcut is already used by the system.",
			"keyboard_shortcuts_can_be_changed": "Keyboard shortcuts can be changed in System Settings.",
			"ok": "OK",
